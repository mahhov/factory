...
let extractorTextures = {
	extractor: new AnimatedGeneratedTextures(16, [[
		[0, 0, 2, 2, colors.cornerGrey],
		[14, 0, 2, 2, colors.cornerGrey],
		[0, 14, 2, 2, colors.cornerGrey],
		[14, 14, 2, 2, colors.cornerGrey],
		[6, 6, 4, 4, colors.tier1],
		[7, 0, 2, 16, colors.axilGrey],
		[0, 7, 16, 2, colors.axilGrey],
		[2, 0, 12, 1, colors.wallGrey],
		[2, 15, 12, 1, colors.wallGrey],
		[0, 2, 1, 12, colors.wallGrey],
		[15, 2, 1, 12, colors.wallGrey],
	]]),
	reinforcedExtractor: new AnimatedGeneratedTextures(24, [[
		[0, 0, 3, 3, colors.cornerGrey],
		[21, 0, 3, 3, colors.cornerGrey],
		[0, 21, 3, 3, colors.cornerGrey],
		[21, 21, 3, 3, colors.cornerGrey],
		[9, 9, 6, 6, colors.tier2],
		[11, 0, 2, 24, colors.axilGrey],
		[0, 11, 24, 2, colors.axilGrey],
		[3, 0, 18, 2, colors.wallGrey],
		[3, 22, 18, 2, colors.wallGrey],
		[0, 3, 2, 18, colors.wallGrey],
		[22, 3, 2, 18, colors.wallGrey],
	]]),
	quadraticExtractor: new AnimatedGeneratedTextures(32, [[
		[0, 0, 4, 4, colors.cornerGrey],
		[28, 0, 4, 4, colors.cornerGrey],
		[0, 28, 4, 4, colors.cornerGrey],
		[28, 28, 4, 4, colors.cornerGrey],
		...
		[4, 0, 24, 3, colors.wallGrey],
		[4, 29, 24, 3, colors.wallGrey],
		[0, 4, 3, 24, colors.wallGrey],
		[29, 4, 3, 24, colors.wallGrey],
	]]),
	laserExtractor: new AnimatedGeneratedTextures(32, [[
		[0, 0, 4, 4, colors.cornerGrey],
		[28, 0, 4, 4, colors.cornerGrey],
...
let factoryTextures = {
	...
	plasteelMixer: new AnimatedGeneratedTextures(24, [[
		...
		[9, 0, 6, 2, colors.wallGrey],
		[9, 22, 6, 2, colors.wallGrey],
		[0, 9, 2, 6, colors.wallGrey],
		[22, 9, 2, 6, colors.wallGrey],
		[0, 0, 3, 3, colors.cornerGrey],
		[21, 0, 3, 3, colors.cornerGrey],
		[0, 21, 3, 3, colors.cornerGrey],
		[21, 21, 3, 3, colors.cornerGrey],
	...
	thermiteForge: new AnimatedGeneratedTextures(32, [[
		...
		[10, 0, 12, 3, colors.wallGrey],
		[10, 29, 12, 3, colors.wallGrey],
		[0, 10, 3, 12, colors.wallGrey],
		[29, 10, 3, 12, colors.wallGrey],
		[0, 0, 4, 4, colors.cornerGrey],
		[28, 0, 4, 4, colors.cornerGrey],
		[0, 28, 4, 4, colors.cornerGrey],
		[28, 28, 4, 4, colors.cornerGrey],
...
let ventTextures = {
	...
	waterVent: new AnimatedGeneratedTextures(8, [[
		[0, 0, 8, 8, colors.backgroundGrey],
		[2, 0, 4, 1, colors.wallGrey],
		[2, 7, 4, 1, colors.wallGrey],
		[0, 2, 1, 4, colors.wallGrey],
		[7, 2, 1, 4, colors.wallGrey],
		[1, 1, 6, 6, '#000088'],
		[2, 2, 4, 4, '#00ccff'],
		[3, 1, 2, 6, colors.wallGrey],
		[1, 3, 6, 2, colors.wallGrey],
	]]),
	methaneVent: new AnimatedGeneratedTextures(16, [[
		[0, 0, 16, 16, colors.backgroundGrey],
		[4, 0, 8, 2, colors.wallGrey],
		[4, 14, 8, 2, colors.wallGrey],
		[0, 4, 2, 8, colors.wallGrey],
		[14, 4, 2, 8, colors.wallGrey],
		[4, 4, 8, 8, '#33cc66'],
		[7, 4, 2, 8, colors.white],
		[4, 7, 8, 2, colors.white],
		[7, 7, 2, 2, colors.tier3],
	]]),
};
