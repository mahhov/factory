...
import {Conveyor, Distributor, Empty, Entity, Extractor, GlassFactory, Junction, MegaFactory, Turret, Wall} from '../world/Entity.js';
...
export default class Placer {
	...
	static readonly entityClasses: typeof Entity[] =
		[Wall, Conveyor, Distributor, Junction, Extractor, GlassFactory, MegaFactory, Turret];
